...
export const ASSET_CATALOG: AssetDefinition[] = [
  ...
  },
  {
    ...
    name: "PA Speaker",
    category: "AV Gear",
    thumbnail: makeThumb("Speaker", ["#BA7517", "#8C5315"]),
    modelUrl: "primitive://speaker",
    defaultScale: [0.9, 1.2, 0.9],
    boundingBox: { width: 0.8, depth: 0.8, height: 1.6 },
    yOffset: 0,
  },
  {
    id: "asset-mixing-desk",
    type: "mixing_desk",
    name: "Mixing Desk",
    category: "AV Gear",
    thumbnail: makeThumb("Mixer", ["#534AB7", "#2A3F6F"]),
    modelUrl: "primitive://mixing_desk",
    defaultScale: [1.2, 0.7, 0.8],
    boundingBox: { width: 1.4, depth: 0.9, height: 0.8 },
    yOffset: 0,
  },
];
