...
import { Eye, Expand, Layers3, Minus, Plus, Lock } from "lucide-react";
    ...
    <ProtectedRoute>
      <div className="flex h-screen flex-col bg-(--sf-bg)">
        ...
        <div className="flex min-h-0 flex-1">
          ...
          >
            <div className="absolute right-5 top-4 z-20 rounded-xl border border-[#e8ece9] bg-white px-4 py-2 text-[12px] font-semibold text-[#70807b] shadow-[0_2px_10px_rgba(15,23,42,0.08)]">
            ...
            >
              ...
              <button
                onClick={() =>
                  setActiveLayer(
                    activeLayer === "combined" ? "layout" : "combined",
                  )
                }
            ...
            <div
              className={`absolute bottom-4 right-5 z-20 flex items-center gap-2 ${presentationMode ? "hidden" : ""}`}
            >
