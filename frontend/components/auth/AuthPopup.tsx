...
import { ArrowRight, Lock, Mail, Shield, Sparkles, X } from "lucide-react";
...
export function AuthPopup({
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/78 px-4 py-5 backdrop-blur-[1px]">
      <div className="grid w-full max-w-[1040px] overflow-hidden rounded-[16px] border border-white/40 bg-white shadow-[0_26px_80px_rgba(0,0,0,0.28)] md:grid-cols-[0.92fr_0.88fr]">
        <aside className="hidden min-h-[540px] bg-[#77968c] bg-[radial-gradient(circle_at_1px_1px,rgba(255,255,255,0.18)_1px,transparent_0)] [background-size:22px_22px] px-12 py-12 text-white md:flex md:flex-col">
          ...
          <div className="my-auto">
            ...
            <h2 className="mt-8 max-w-[500px] text-[36px] font-semibold leading-[1.08] tracking-[-0.03em]">
        ...
        <section className="relative px-8 py-8 md:px-12 md:py-12">
          <button
            type="button"
            onClick={onClose}
            aria-label="Close authentication popup"
            className="absolute right-6 top-6 rounded-full p-1 text-[#6e7c77] transition hover:bg-[#f1f5f3] hover:text-[#1b2421]"
          >
            <X size={22} />
          </button>
          ...
          <p className="mt-3 text-[18px] leading-7 text-[#74817c]">
            {isRegister
              ...
              : "Sign in and continue the venue flow you started."}
          </p>
